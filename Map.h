...
public:
    ...
    char getTile(int x, int y) const;// Retorna o caractere numa posição específica  
    void setTile(int x, int y, char newTile);// Atualiza o caractere numa posição específica  
